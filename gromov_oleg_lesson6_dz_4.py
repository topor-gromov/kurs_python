...
# Можно реализовать и сохранение данных в словарь, где key будет равно user1, user2,...., а Value равно словарю с ключами:
# Фамилия, имя, Отчество, Хобби (список). Но мне кажется что реализоция со списком более логичная.
